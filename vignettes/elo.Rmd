...
In this way, you could adjust the intercept for games played on neutral fields (for example).
...
Finally, do note that using `adjust()` isn't sufficient for adjusting for games played on neutral ground,
